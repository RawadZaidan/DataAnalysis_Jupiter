...
-- Create indexes for match_id and player_id
CREATE INDEX IF NOT EXISTS idx_match_id ON premier_league.fact_player_performance(match_id);
CREATE INDEX IF NOT EXISTS idx_player_id ON premier_league.fact_player_performance(player_id);

-- -- Insert data into the fact_player_performance table
-- INSERT INTO premier_league.fact_player_performance (match_date, match_id, player_id, 
